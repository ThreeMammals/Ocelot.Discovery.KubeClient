...
public class WatchKubeTests
{
    ...
    public async Task GetAsync_EndpointsEventObserved_ServicesReturned(ResourceEventType eventType, int expectedServicesCount)
    {
        ...
        // Assert
        Assert.Equal(expectedServicesCount, services.Count);
    }
    ...
    public async Task GetAsync_NoEventsAfterTimeout_EmptyServicesReturned()
    {
        ...
        Assert.Equal(TimeSpan.FromSeconds(WatchKube.FirstResultsFetchingTimeoutSeconds).Ticks, _testScheduler.Clock);
        _logger.Verify(
    ...
    public async Task GetAsync_WatchFailed_RetriedAfterDelay()
    {
        ...
        Assert.Equal(TimeSpan.FromSeconds(WatchKube.FailedSubscriptionRetrySeconds).Ticks, _testScheduler.Clock);
        _logger.Verify(
